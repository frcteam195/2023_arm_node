...
class LowConeState(StateMachine.State):
    ...
    def __init__(self, machine, arm, side=ArmStateMachine.GoalSides.FRONT):
        ...
        self.position: ArmPosition = POS_LOW_CONE
    ...
    def get_enum(self):
        if self.side is ArmStateMachine.GoalSides.FRONT:
            return ArmStateMachine.States.LOW_CONE_FRONT
        else:
            return ArmStateMachine.States.LOW_CONE_BACK
