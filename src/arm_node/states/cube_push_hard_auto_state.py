...
class CubePushHardAutoState(StateMachine.State):
    ...
    def __init__(self, machine, arm, side=ArmStateMachine.GoalSides.FRONT):
        ...
        self.position: ArmPosition = POS_CUBE_PUSH_HARD_AUTO
    ...
    def get_enum(self):
        if self.side is ArmStateMachine.GoalSides.FRONT:
            return ArmStateMachine.States.CUBE_PUSH_HARD_AUTO_FRONT
        else:
            return ArmStateMachine.States.CUBE_PUSH_HARD_AUTO_BACK
