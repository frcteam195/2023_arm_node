...
class SportModeState(StateMachine.State):
    ...
    def __init__(self, machine, arm, side=ArmStateMachine.GoalSides.FRONT):
        ...
        self.position: ArmPosition = POS_SPORT_MODE
    ...
    def get_enum(self):
        if self.side is ArmStateMachine.GoalSides.FRONT:
            return ArmStateMachine.States.SPORT_MODE_FRONT
        else:
            return ArmStateMachine.States.SPORT_MODE_BACK
