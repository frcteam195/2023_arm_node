...
class SidewaysDeadCone(StateMachine.State):
    ...
    def __init__(self, machine, arm, side=ArmStateMachine.GoalSides.FRONT):
        ...
        self.position: ArmPosition = POS_SIDEWAYS_DEAD_CONE
    ...
    def get_enum(self):
        if self.side is ArmStateMachine.GoalSides.FRONT:
            return ArmStateMachine.States.SIDEWAYS_DEAD_CONE_FRONT
        else:
            return ArmStateMachine.States.SIDEWAYS_DEAD_CONE_BACK
