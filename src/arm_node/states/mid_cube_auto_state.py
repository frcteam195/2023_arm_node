...
class MidCubeAutoState(StateMachine.State):
    ...
    def __init__(self, machine, arm, side=ArmStateMachine.GoalSides.FRONT):
        ...
        self.position: ArmPosition = POS_MID_CUBE_AUTO
    ...
    def get_enum(self):
        if self.side is ArmStateMachine.GoalSides.FRONT:
            return ArmStateMachine.States.MID_CUBE_AUTO_FRONT
        else:
            return ArmStateMachine.States.MID_CUBE_AUTO_BACK
