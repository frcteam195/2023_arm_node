...
POS_HIGH_CUBE = ArmPosition(8, 100, -8, -100)
...
POS_HIGH_CONE_EXTENSION_INTERMEDIATE = ArmPosition(13, 90, -19, -90)
# POS_HIGH_CONE_EXTENSION_INTERMEDIATE = ArmPosition(0, 100.0, 0, -100.0)
