...
POS_STEAL = ArmPosition(16.70, 82.08) #fake values
...
POS_HIGH_CUBE = ArmPosition(18.5, 117.0) #18.5
...
POS_HIGH_CONE = ArmPosition(21.74, 128.88) # may exceed limits
...
def __rotation_to_angle(rotation: ArmPosition) -> ArmPosition:
        #
        #   Returns the arm position in rotation based on the given angles from each home value
        #
        new_pos = ArmPosition()
        new_pos.base_position = rotation.base_position * 360.0 + POS_HOME.base_position
        new_pos.upper_position = rotation.upper_position * 360.0 + POS_HOME.upper_position
